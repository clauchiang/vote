...
<div>
    <div class="order">
        ...
        ?>
            <div>依熱門度排序<a href='?do=vote_old&order=total&type=desc'> ▲ </a></div>
        <?php
        } else {
        ?>
            <div>依熱門度排序<a href='?do=vote_old&order=total&type=asc'> ▼ </a></div>
        <?php
        }
        ?>
        <?php
        ...
        if (isset($_GET['type']) && $_GET['type'] == 'asc') {
        ?>
            <div>依時間排序<a href='?do=vote_old&order=end&type=desc'> ▲ </a></div>
        <?php
        } else {
        ?>
            <div>依時間排序<a href='?do=vote_old&order=end&type=asc'> ▼ </a></div>
        <?php
        }
        ?>
    </div>

    <h2 class="listTitle">已結束的投票</h2>
